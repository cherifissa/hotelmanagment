...
!(function (t, e) {
    ...
    (((s.prototype = Object.create(Promise.prototype)).constructor =
            ...
            return this.thenList([
                ...
                for (var p = 0; p < o; p++) {
                    p === o - 1 &&
                        ((a.height = r % n),
                        (i =
                            (a.height * this.prop.pageSize.inner.width) /
                            a.width));
                    var h = a.width,
                        u = a.height;
                    (s.fillStyle = "white"),
        ...
        (s.prototype.setPageSize = function (t) {
            ...
            return this.then(function () {
                (t = t || l.getPageSize(this.opt.jsPDF)).hasOwnProperty(
                    "inner"
                ) ||
                    ((t.inner = {
                        width:
        ...
        i = {
            toContainer: (s.prototype.toContainer = function () {
                return o.toContainer.call(this).then(function () {
                    var t = this.prop.container.querySelectorAll(
