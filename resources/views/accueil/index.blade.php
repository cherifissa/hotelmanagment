            ...
            <div class="container">
                @if (session('success'))
                    <script type="text/javascript">
                        ...
                        Toast.fire({
                            icon: 'success',
                            title: 'Réservation fait avec succès'
                        })
                    </script>
                @endif
                <div class="row mt-">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="online_book text-white bg-dark" name="type_chambre">
                                            <option value="standard"
                                                {{ old('type_chambre') === 'standard' ? 'selected' : '' }}>Standard</option>
                                            <option value="privilege"
                                                {{ old('type_chambre') === 'privilege' ? 'selected' : '' }}>Privilège
                                            </option>
                                            <option value="suite junior"
                                                {{ old('type_chambre') === 'suite junior' ? 'selected' : '' }}>Suite Junior
                                            </option>
                                            <option value="suite VIP"
                                                {{ old('type_chambre') === 'suite VIP' ? 'selected' : '' }}>Suite VIP
                                            </option>
                                        </select>
                                        @error('type_chambre')
                                            <div class="text-danger">{{ $message }}</div>
