...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex p-0">
            <h3 class="card-title p-3">Liste des utilisateurs</h3>
            <ul class="nav nav-pills ml-auto p-2">
                <li class="nav-item">
                    <a class="btn btn-block btn-success" href="/admin/users/create">Ajouter</a>
                </li>
            </ul>
        </div><!-- /.card-header -->
    </div>
                ...
                <tr class="table-active">
                    ...
                    <td>
                        <div class="d-flex justify-content-evenly">
                            ...
                            <form action="{{ route('users.destroy', $user) }}" id="delete-form" method="POST">
                                @csrf
                                @method('delete')
