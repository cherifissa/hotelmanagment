                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status">
                                <option value="checkin" {{ old('status', $reservation->status) === 'checkin' ?
                                    'selected' : '' }}>Check-in
                                </option>
                                <option value="checked" {{ old('status', $reservation->status) === 'checked' ?
                                    'selected' : '' }}>Checked
                                </option>
                                <option value="pending" {{ old('status', $reservation->status) === 'checked' ?
                                    'selected' : '' }}>Pending
                                </option>
                                <option value="annule" {{ old('status', $reservation->status) === 'annule' ? 'selected'
                                    : '' }}>Annulé
                                </option>
                            </select>
                            @error('status')
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="date_arrive" value="{{ old('date_arrive', $reservation->date_arrive) }}">
                            @error('date_arrive')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="date_depart" value="{{ old('date_depart', $reservation->date_depart) }}">
                            @error('date_depart')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="nbr_jour" value="{{ old('nbr_jour', $reservation->nbr_jour) }}">
                            @error('nbr_jour')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
